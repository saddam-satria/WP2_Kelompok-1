<div class="py-1" style="background-color: #4663be; position: sticky; top: 0; z-index: 100;">
    <div class="container">
        <div class="d-flex align-items-center">
            ...
            <div class="ms-auto">
                <div class="btn-group">
                    <img style="width: 60px; height: 60px; object-fit: cover; cursor: pointer;" class="img-fluid rounded-circle" src="<?= is_null(session()->current_user[0]["image"]) ? base_url("assets/img/avatar.jpg")  : base_url("assets/" . session()->current_user[0]["image"])  ?>" alt="asdsa" data-bs-toggle="dropdown" data-bs-display="static" aria-expanded="false"></img>
                    <div class="dropdown-menu dropdown-menu-end dropdown-menu-md-start">
                        <div style="width: 18rem;">
                            <div class="card-body">
                                <div class="d-flex align-items-center flex-column">
                                    <img style="width: 100px; height: 100px; object-fit: cover;" class="img-fluid rounded-circle" src="<?= is_null(session()->current_user[0]["image"]) ? base_url("assets/img/avatar.jpg")  : base_url("assets/" . session()->current_user[0]["image"])  ?>" alt="asdsa" data-bs-toggle="dropdown" data-bs-display="static" aria-expanded="false"></img>
...
<div style=" z-index: 100; height: 100vh; position: fixed;background-color: #4663be; padding-right: 6rem !important; transition: all ease-in-out 300ms 10ms;" class="px-2" id="user-sidebar">
